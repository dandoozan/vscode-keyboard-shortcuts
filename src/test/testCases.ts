    ...
    string: {
      ...
      cut: {
        ...
        testCases: [
          ...
          {
            desc: 'should NOT cut when cursor is not inside a string',
            startingCode: '("String contents")',
            cursorPosition: 0,
            endingCode: '("String contents")',
          ...
          {
            desc: 'should cut strings when multiple cursors are inside strings',
            startingCode: '("String1" + "String2")',
            cursorPosition: [2, 17],
            endingCode: '("" + "")',
      ...
      copy: {
        ...
        testCases: [
          ...
          {
            desc: 'should NOT copy when cursor is not inside a string',
            startingCode: '("String contents")',
            cursorPosition: 0,
            expectedSelections: [''],
            expectedClipboardContent: 'PreviousClipboardContent',
    ...
    item: {
      select: {
        testCases: [
          ...
          {
            desc: 'should NOT select when cursor is not inside an item',
            startingCode: '(["item1"])',
            cursorPosition: 0,
            expectedSelections: [''],
          },
          {
            desc: 'should select items when multiple cursors are inside items',
