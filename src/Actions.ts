...
export default class Actions {
  static async select(editor: TextEditor, boundaries: Boundary[] | undefined) {
  ...
  static async delete(editor: TextEditor, boundaries: Boundary[] | undefined) {
    if (boundaries && boundaries.length > 0) {
  ...
  static async replace(editor: TextEditor, boundaries: Boundary[] | undefined) {
    if (boundaries && boundaries.length > 0) {
